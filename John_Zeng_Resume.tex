...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Created a shell interface capable of executing commands with \textbf{subshell}, if/while statements, script execution, and \textbf{wildcarding} in addition to all basic terminal functions like \textbf{pipes}, environment variables, and \textbf{file system traversal}.
            }
          \resumeItemListEnd
