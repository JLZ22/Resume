...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Rust, Python, Java, C, C++, Javascript/Typescript, SQL, HTML, CSS} \\
     \textbf{Frameworks}{: Svelte, Textual, Tauri, Ultralytics, Tensorflow, Keras, Pytorch} \\
     \textbf{Libraries}{: OpenCV, Imgaug, NumPy, Pandas} \\
    }}
 \end{itemize}
