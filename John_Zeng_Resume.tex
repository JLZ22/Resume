  ...
  \resumeSubHeadingListStart
    ...
    % include project overview (industry known terms)
      ...
      \resumeItemListStart
        ...
        \resumeItem{Optimize frame rate by leveraging a combination of \textbf{asynchronous runtimes} and \textbf{multi-threading} to process camera inputs in parallel.}
    ...
    {Draper Dragon}{San Mateo, CA}
      \resumeItemListStart
        ...
        \resumeItem{Wrote investment \href{https://drive.google.com/file/d/14b7ZHeRLfU3-GW80YL8XoYoTLx4nNZax/view?usp=sharing}{\underline{memos}} detailing company financials, market opportunity, risk factors, value proposition, etc.}
        \resumeItemListEnd
    \resumeSubHeadingListEnd
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Rugby Drill Simulator} $|$ \emph{Python, Coq}}
          \resumeItemListStart
            \resumeItem{Using Python to simulate a common rugby passing drill ("infinite passing")
            }
            \resumeItem{Aims to find an algorithm that can determine if any given set of inputs will result in a zero oscillation drill.}
          \resumeItemListEnd
